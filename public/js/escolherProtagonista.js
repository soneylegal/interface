    ...
    mostrarOpcoes([
      {
        texto: "1: Atirador",
        acao: () => {
          // Cria uma nova instância de CaixaItens para cada jogador,
          // para que o inventário seja independente.
          ...
          resolve(jogador); // Resolve a Promise com o jogador escolhido
        },
      },
      {
